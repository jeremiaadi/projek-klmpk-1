...
<head>
    ...
    <title>Berakar - Manajemen Lowongan Kerja</title>
    <style>
        body {
            display: flex;
            margin: 0;
        ...
        .main-content {
            margin-left: 270px; /* Adjust this to prevent overlap */
            padding: 20px;
            margin-top: 20px;
            overflow: hidden;
            flex-grow: 1;
...
<body>
    ...
    <div class="main-content">
        <div class="card">
            ...
            <div>
                <a href="db_loker/add.php" class="add-button">Masukan Lowongan Kerja Baru</a>
            </div> 
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="db_loker/detail.php?id=<?php echo $row['id_loker'] ; ?>" class="btn btn-primary btn-sm">Detail</a> 
                                <a href="db_loker/edit.php?id=<?php echo $row['id_loker'] ; ?>" class="btn btn-success btn-sm">Edit</a> 
                                <a href="db_loker/delete.php?id=<?php echo $row['id_loker'] ; ?>"  class="btn btn-danger btn-sm">Delete</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
