	  		...
	  		<div class="col-md-12 mt-5">
				  ...
				  <tbody>
				    ...
				    <tr>
				      ...
				      <td>
				      	<a href="detail.php?id=<?php echo $row['id_bea'] ; ?>" class="btn btn-primary btn-sm">Detail</a> 
				      	<a href="edit.php?id=<?php echo $row['id_bea'] ; ?>" class="btn btn-success btn-sm">Edit</a> 
				      	<a href="delete.php?id=<?php echo $row['id_bea'] ; ?>"  class="btn btn-danger btn-sm">Delete</a>
				      </td>
				    </tr>
				    <?php } ?>
				  </tbody>
